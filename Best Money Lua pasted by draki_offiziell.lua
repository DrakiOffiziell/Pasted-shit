...
menu.action(menu.my_root(), "Biggest Money Explosion in your bank/wallet (idk how safe)", {}, "PRESS ONLY ONCE!!! or more idk", function()
    ...
    trigger_transaction(util.joaat("SERVICE_EARN_JOB_BONUS_CRIMINAL_MASTERMIND"), 15000000  )
    trigger_transaction(util.joaat("SERVICE_EARN_GANGOPS_AWARD_MASTERMIND_3"), 7000000)
    trigger_transaction(util.joaat("SERVICE_EARN_CASINO_HEIST_FINALE"), 3619000)
    trigger_transaction(util.joaat("SERVICE_EARN_AGENCY_STORY_FINALE"), 3000000)
    trigger_transaction(util.joaat("SERVICE_EARN_GANGOPS_AWARD_MASTERMIND_2"), 3000000)
    trigger_transaction(util.joaat("SERVICE_EARN_ISLAND_HEIST_FINALE"), 2550000)
    trigger_transaction(util.joaat("SERVICE_EARN_GANGOPS_FINALE"), 2550000)
    trigger_transaction(util.joaat("SERVICE_EARN_JOB_BONUS_HEIST_AWARD"), 2000000)
    trigger_transaction(util.joaat("SERVICE_EARN_TUNER_ROBBERY_FINALE"), 2000000)
    trigger_transaction(util.joaat("SERVICE_EARN_GANGOPS_AWARD_ORDER"), 2000000)
    trigger_transaction(util.joaat("SERVICE_EARN_FROM_BUSINESS_HUB_SELL"), 2000000)
    trigger_transaction(util.joaat("SERVICE_EARN_GANGOPS_AWARD_LOYALTY_AWARD_4"), 1500000  )
    trigger_transaction(util.joaat("SERVICE_EARN_BOSS_AGENCY"), 1200000)
    trigger_transaction(util.joaat("SERVICE_EARN_DAILY_OBJECTIVES"), 1000000)
    trigger_transaction(util.joaat("SERVICE_EARN_MUSIC_STUDIO_SHORT_TRIP"), 1000000)
    trigger_transaction(util.joaat("SERVICE_EARN_DAILY_OBJECTIVE_EVENT"), 1000000)
    trigger_transaction(util.joaat("SERVICE_EARN_JUGGALO_STORY_MISSION"), 1000000)
    trigger_transaction(util.joaat("SERVICE_EARN_GANGOPS_AWARD_LOYALTY_AWARD_3"), 700000   )
    trigger_transaction(util.joaat("SERVICE_EARN_BETTING"), 680000)
    trigger_transaction(util.joaat("SERVICE_EARN_FROM_VEHICLE_EXPORT"), 620000)
    trigger_transaction(util.joaat("SERVICE_EARN_ISLAND_HEIST_AWARD_MIXING_IT_UP"), 500000)
    trigger_transaction(util.joaat("SERVICE_EARN_WINTER_22_AWARD_JUGGALO_STORY"), 500000)
    trigger_transaction(util.joaat("SERVICE_EARN_CASINO_AWARD_STRAIGHT_FLUSH"), 500000)
    trigger_transaction(util.joaat("SERVICE_EARN_ISLAND_HEIST_AWARD_PROFESSIONAL"), 400000)
    trigger_transaction(util.joaat("SERVICE_EARN_ISLAND_HEIST_AWARD_CAT_BURGLAR"), 400000)
    trigger_transaction(util.joaat("SERVICE_EARN_ISLAND_HEIST_AWARD_ELITE_THIEF"), 400000)
    trigger_transaction(util.joaat("SERVICE_EARN_ISLAND_HEIST_AWARD_THE_ISLAND_HEIST"), 400000)
    trigger_transaction(util.joaat("SERVICE_EARN_CASINO_HEIST_AWARD_ELITE_THIEF"), 350000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_BLAST"), 300000)
    trigger_transaction(util.joaat("SERVICE_EARN_PREMIUM_JOB"), 300000)
    trigger_transaction(util.joaat("SERVICE_EARN_GANGOPS_AWARD_LOYALTY_AWARD_2"), 300000)
    trigger_transaction(util.joaat("SERVICE_EARN_CASINO_HEIST_AWARD_ALL_ROUNDER"), 300000)
    trigger_transaction(util.joaat("SERVICE_EARN_ISLAND_HEIST_AWARD_PRO_THIEF"), 300000)
    trigger_transaction(util.joaat("SERVICE_EARN_YOHAN_SOURCE_GOODS"), 300000)
    trigger_transaction(util.joaat("SERVICE_EARN_SMUGGLER_AGENCY"), 270000)
    trigger_transaction(util.joaat("SERVICE_EARN_FIXER_AWARD_AGENCY_STORY"), 250000)
    trigger_transaction(util.joaat("SERVICE_EARN_CASINO_HEIST_AWARD_PROFESSIONAL"), 250000)
    trigger_transaction(util.joaat("SERVICE_EARN_GANGOPS_AWARD_SUPPORTING"), 200000)
    trigger_transaction(util.joaat("SERVICE_EARN_COLLECTABLES_ACTION_FIGURES"), 200000)
    trigger_transaction(util.joaat("SERVICE_EARN_ISLAND_HEIST_AWARD_GOING_ALONE"), 200000)
    trigger_transaction(util.joaat("SERVICE_EARN_JOB_BONUS_FIRST_TIME_BONUS"), 200000)
    trigger_transaction(util.joaat("SERVICE_EARN_GANGOPS_AWARD_FIRST_TIME_XM_SILO"), 200000)
    trigger_transaction(util.joaat("SERVICE_EARN_DOOMSDAY_FINALE_BONUS"), 200000)
    trigger_transaction(util.joaat("SERVICE_EARN_GANGOPS_AWARD_FIRST_TIME_XM_BASE"), 200000)
    trigger_transaction(util.joaat("SERVICE_EARN_COLLECTABLE_COMPLETED_COLLECTION"), 200000)
    trigger_transaction(util.joaat("SERVICE_EARN_ISLAND_HEIST_ELITE_CHALLENGE"), 200000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_CHECKPOINT_COLLECTION"), 200000)
    trigger_transaction(util.joaat("SERVICE_EARN_GANGOPS_AWARD_FIRST_TIME_XM_SUBMARINE"), 200000)
    trigger_transaction(util.joaat("SERVICE_EARN_ISLAND_HEIST_AWARD_TEAM_WORK"), 200000)
    trigger_transaction(util.joaat("SERVICE_EARN_CASINO_HEIST_ELITE_DIRECT"), 200000)
    trigger_transaction(util.joaat("SERVICE_EARN_CASINO_HEIST_ELITE_STEALTH"), 200000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_TIME_TRIAL"), 200000)
    trigger_transaction(util.joaat("SERVICE_EARN_CASINO_HEIST_AWARD_UNDETECTED"), 200000)
    trigger_transaction(util.joaat("SERVICE_EARN_CASINO_HEIST_ELITE_SUBTERFUGE"), 200000)
    trigger_transaction(util.joaat("SERVICE_EARN_GANGOPS_ELITE_XM_SILO"), 200000)
    trigger_transaction(util.joaat("SERVICE_EARN_VEHICLE_SALES"), 190000)
    trigger_transaction(util.joaat("SERVICE_EARN_JOBS"), 180000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_RC_TIME_TRIAL"), 165000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_BEAST"), 150000)
    trigger_transaction(util.joaat("SERVICE_EARN_CASINO_HEIST_AWARD_IN_PLAIN_SIGHT"), 150000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_SOURCE_RESEARCH"), 150000)
    trigger_transaction(util.joaat("SERVICE_EARN_GANGOPS_ELITE_XM_SUBMARINE"), 150000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_KING"), 120000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_PENNED_IN"), 120000)
    trigger_transaction(util.joaat("SERVICE_EARN_SIGHTSEEING_REWARD"), 115000)
    trigger_transaction(util.joaat("SERVICE_EARN_CASINO_AWARD_HIGH_ROLLER_PLATINUM"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_TUNER_AWARD_BOLINGBROKE_ASS"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_CASINO_AWARD_FULL_HOUSE"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_AGENCY_SECURITY_CONTRACT"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_DAILY_STASH_HOUSE_COMPLETED"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_CASINO_AWARD_MISSION_SIX_FIRST_TIME"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_CHALLENGES"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_METAL_DETECTOR"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_HOT_PROPERTY"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_CLUBHOUSE_CONTRACT"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_TUNER_AWARD_FLEECA_BANK"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_SMUGGLER_PLANE"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_FIXER_AWARD_SHORT_TRIP"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_SMUGGLER_TRAIL"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_TUNER_AWARD_METH_JOB"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_CASINO_HEIST_AWARD_SMASH_N_GRAB"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_AGENCY_STORY_PREP"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_WINTER_22_AWARD_DAILY_STASH"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_JUGGALO_PHONE_MISSION"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_GOLDEN_GUN"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_URBAN_WARFARE"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_AGENCY_PAYPHONE_HIT"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_TUNER_AWARD_FREIGHT_TRAIN"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_WINTER_22_AWARD_DEAD_DROP"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_CLUBHOUSE_DUFFLE_BAG"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_WINTER_22_AWARD_RANDOM_EVENT"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_TUNER_AWARD_MILITARY_CONVOY"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_JUGGALO_STORY_MISSION_PARTICIPATION"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_CRIME_SCENE"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_TUNER_AWARD_IAA_RAID"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_ARENA_CAREER_TIER_PROGRESSION_4"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_AUTO_SHOP_DELIVERY_AWARD"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_CASINO_AWARD_TOP_PAIR"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_TUNER_AWARD_UNION_DEPOSITORY"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_UNDERWATER_CARGO"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_COLLECTABLE_ITEM"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_WINTER_22_AWARD_ACID_LAB"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_MAZE_BANK"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_GANGOPS_ELITE_XM_BASE"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_WINTER_22_AWARD_TAXI"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_TUNER_DAILY_VEHICLE_BONUS"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_TUNER_AWARD_BUNKER_RAID"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_AMMUNATION_DELIVERY"), 100000)
    trigger_transaction(util.joaat("SERVICE_EARN_GANGOPS_SETUP"), 90000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_DEAD_DROP"), 80000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_HOT_TARGET_DELIVER"), 80000)
    trigger_transaction(util.joaat("SERVICE_EARN_ARENA_CAREER_TIER_PROGRESSION_3"), 75000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_XMAS_MUGGER"), 70000)
    trigger_transaction(util.joaat("SERVICE_EARN_IMPORT_EXPORT"), 65000)
    trigger_transaction(util.joaat("SERVICE_EARN_FROM_CLUB_MANAGEMENT_PARTICIPATION"), 60000)
    trigger_transaction(util.joaat("SERVICE_EARN_NIGHTCLUB_DANCING_AWARD"), 60000)
    trigger_transaction(util.joaat("SERVICE_EARN_ARENA_CAREER_TIER_PROGRESSION_2"), 55000)
    trigger_transaction(util.joaat("SERVICE_EARN_FROM_BUSINESS_BATTLE"), 50000)
    trigger_transaction(util.joaat("SERVICE_EARN_ISLAND_HEIST_DJ_MISSION"), 50000)
    trigger_transaction(util.joaat("SERVICE_EARN_ARENA_SKILL_LVL_AWARD"), 50000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_GANG_CONVOY"), 50000)
    trigger_transaction(util.joaat("SERVICE_EARN_COLLECTABLES_SIGNAL_JAMMERS_COMPLETE"), 50000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_HELI_HOT_TARGET"), 50000)
    trigger_transaction(util.joaat("SERVICE_EARN_ACID_LAB_SELL_PARTICIPATION"), 50000)
    trigger_transaction(util.joaat("SERVICE_EARN_FROM_CONTRABAND"), 50000)
    trigger_transaction(util.joaat("SERVICE_EARN_CASINO_AWARD_MISSION_THREE_FIRST_TIME"), 50000)
    trigger_transaction(util.joaat("SERVICE_EARN_GOON"), 50000)
    trigger_transaction(util.joaat("SERVICE_EARN_FIXER_AWARD_PHONE_HIT"), 50000)
    trigger_transaction(util.joaat("SERVICE_EARN_CASINO_AWARD_MISSION_FOUR_FIRST_TIME"), 50000)
    trigger_transaction(util.joaat("SERVICE_EARN_TAXI_JOB"), 50000)
    trigger_transaction(util.joaat("SERVICE_EARN_CASINO_AWARD_MISSION_ONE_FIRST_TIME"), 50000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_SHOP_ROBBERY"), 50000)
    trigger_transaction(util.joaat("SERVICE_EARN_ARENA_WAR"), 50000)
    trigger_transaction(util.joaat("SERVICE_EARN_CASINO_AWARD_MISSION_FIVE_FIRST_TIME"), 50000)
    trigger_transaction(util.joaat("SERVICE_EARN_CASINO_AWARD_LUCKY_LUCKY"), 50000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_PASS_PARCEL"), 50000)
    trigger_transaction(util.joaat("SERVICE_EARN_TUNER_CAR_CLUB_MEMBERSHIP"), 50000)
    trigger_transaction(util.joaat("SERVICE_EARN_CASINO_AWARD_MISSION_TWO_FIRST_TIME"), 50000)
    trigger_transaction(util.joaat("SERVICE_EARN_AMBIENT_JOB_HOT_TARGET_KILL"), 50000)
